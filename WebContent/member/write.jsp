	  ...
	  $("#saveMember").click(function(){
		  ...
		  */
		  ...
		  if($("#passwordCheck").val().length==0){
			  ...
			  $("#passwordCheckMessage").html("<span class ='text-danger'>비밀번호 확인을 입력하세요.</span>");
			  $("#passwordCheck").focus();
			  return;
		  }
		  if($("#password").val() != $("#passwordCheck").val()){
			  $("#passwordCheck").addClass("is-invalid");
			  $("#passwordCheckMessage").html("<span class ='text-danger'>비밀번호가 일치하지 않습니다.</span>");
			  $("#passwordCheck").val("");
			  $("#passwordCheck").focus();
			  return;
		  }
			  ...
			  url : 'check_email_ajax.jsp?email='+$("#email").val(),
				...
				success : function(json){
					...
					if(json.result == "ok"){
						...
						$("#email").addClass("is-invalid");
						$("#emailMessage").html("<span class ='text-danger'>중복 된 이메일 입니다.</span>")
						$("#checkEmail").val("no");
					}
				}
		  });
